...
TEST_COMMAND="export HOSTNAME=localhost && export ANT_OPTS='-Xmx512M -Dperegrine.test.backend=processes -Dperegrine.test.portOffset=500 -Dmulti.factors=2 -Dmulti.configs=1:1:1' && time ant test"
