...
TEST_COMMAND="export HOSTNAME=localhost && export ANT_OPTS='-Xmx512M -Dperegrine.test.backend=processes -Dperegrine.test.portOffset=750 -Dmulti.factors=2 -Dmulti.configs=2:1:4' && time ant test"
