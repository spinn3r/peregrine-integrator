...
TEST_COMMAND="ulimit -n 100000 && export HOSTNAME=localhost && export ANT_OPTS='-Xmx512M -Dperegrine.test.backend=threads -Dperegrine.test.portOffset=200 -Dmulti.factors=1 -Dmulti.configs=1:1:1' && time ant test"
